...
url = 'https://www.taopiaopiao.com/cityAction.json?activityId&_ksTS=1639800584489_137&jsoncallback=jsonp138&action=cityAction&n_s=new&event_submit_doGetAllRegion=true'
...
with open('18_Urllib_解析_jsonpath解析淘票票.json','w',encoding='utf-8') as fp:
    fp.write(content)

import json
import jsonpath
obj = json.load(open('18_Urllib_解析_jsonpath解析淘票票.json','r',encoding='utf-8'))
